...
- [WS-Python repo push target](reference_ws_python_repo_push.md) — Adafruit_Wippersnapper_Python HIL branch hil-test-suite / PR adafruit#271: push to adafruit UPSTREAM directly (not a fork), via the `tyeth` gh account (tyeth-ai-assisted 404s); rebase onto upstream first (CI proof commits diverge it)
